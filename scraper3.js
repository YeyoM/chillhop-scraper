...
let urls = [
  ...
  'https://chillhop.com/releases/chillhop-essentials-winter-2019/',
  'https://chillhop.com/releases/xander-found-memories/',
  'https://chillhop.com/releases/fantompower-infinite-i/',
  'https://chillhop.com/releases/aviino-plush/',
  'https://chillhop.com/releases/mrkafer-on-the-rhodes/',
  ...
  'https://chillhop.com/releases/chillhop-essentials-fall-2019/',
  'https://chillhop.com/releases/sleepy-fish-my-room-becomes-the-sea/',
  'https://chillhop.com/releases/ian-ewing-always-home/',
  'https://chillhop.com/releases/kupla-coniferous/',
  'https://chillhop.com/releases/ajmw-eternal/',
  'https://chillhop.com/releases/chillhop-daydreams-2/',
  'https://chillhop.com/releases/junior-state-levitate/',
  'https://chillhop.com/releases/the-kount-function/',
  'https://chillhop.com/releases/toonorth-ambedo/',
  'https://chillhop.com/releases/misha-cocabona-monma-aura/',
  'https://chillhop.com/releases/weird-inside-be-alright/',
  'https://chillhop.com/releases/build/',
  'https://chillhop.com/releases/middle-school-the-finish-line/',
  'https://chillhop.com/releases/back-to-life/',
  'https://chillhop.com/releases/lost-tape/',
  'https://chillhop.com/releases/chillhop-essentials-summer-2019/',
  'https://chillhop.com/releases/migration/',
  'https://chillhop.com/releases/notes/',
  'https://chillhop.com/releases/fried-potatoes-clone/',
  'https://chillhop.com/releases/mangroves/',
  'https://chillhop.com/releases/effervescent/',
  'https://chillhop.com/releases/second-wind/',
  'https://chillhop.com/releases/clocks-forward/',
  'https://chillhop.com/releases/quietly/',
  'https://chillhop.com/releases/stagnant/',
  'https://chillhop.com/releases/second-wind/',
  'https://chillhop.com/releases/im-ready/',
  'https://chillhop.com/releases/home/',
  'https://chillhop.com/releases/awakening/',
  'https://chillhop.com/releases/self-reflection/',
  'https://chillhop.com/releases/chillhop-essentials-spring-2019/',
  'https://chillhop.com/releases/patio/',
  'https://chillhop.com/releases/where-i-met-you/',
  'https://chillhop.com/releases/lemon/',
  'https://chillhop.com/releases/fat-bao/',
  'https://chillhop.com/releases/alive/',
  'https://chillhop.com/releases/arcade/',
  'https://chillhop.com/releases/o-r-b-i-t/',
  'https://chillhop.com/releases/interstellar/',
  'https://chillhop.com/releases/faces/',
  'https://chillhop.com/releases/love-from-ngc-7318/',
  'https://chillhop.com/releases/melting-ice/',
  'https://chillhop.com/releases/chillhop-essentials-winter-2018/',
]
